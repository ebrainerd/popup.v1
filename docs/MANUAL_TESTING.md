...
| 4 | Click **Test camera** (before shop opens or while open, not live) | Single preview area shows your camera; **Preview — only you can see this** badge; mic mute works; buyers still see cover photo on shop page |
