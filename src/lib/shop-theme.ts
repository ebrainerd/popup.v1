...
export const SHOP_THEME_PRESET_META: Record<ShopThemePreset, ShopThemePresetMeta> = {
  default: {
    ...
    tagline: "Bold & warm",
    description:
      "Dark warm charcoal canvas with an ember accent glow and punchy sans-serif type. Best for hype drops and live energy.",
    defaultAccent: "#ff5c1a",
    swatch: "linear-gradient(135deg, #12110f 0%, #ff5c1a 55%, #f5c518 100%)",
  },
  gallery: {
    id: "gallery",
    label: "Atelier",
    ...
    description:
      "Warm parchment surfaces, serif headings, and a honey-gold accent. Ideal for art, prints, and collectible drops.",
    defaultAccent: "#c4921a",
    swatch: "linear-gradient(135deg, #faf7f0 0%, #f5ede0 50%, #c4921a 100%)",
  },
  dark_room: {
    id: "dark_room",
    label: "After Dark",
    ...
    description:
      "Near-black charcoal with an amber accent and tight corners. Built for streetwear, music, and after-hours releases.",
    defaultAccent: "#e8910c",
    swatch: "linear-gradient(135deg, #0e0c0a 0%, #1a1612 50%, #e8910c 100%)",
  },
  market_stall: {
    id: "market_stall",
    label: "Market Stall",
