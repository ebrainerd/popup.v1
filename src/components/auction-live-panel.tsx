...
export function AuctionLivePanel({
  ...
  return (
    ...
    >
      ...
      {isLive && allowBids && (
        <div className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background/95 px-4 py-2.5 backdrop-blur supports-[backdrop-filter]:bg-background/80 lg:hidden">
